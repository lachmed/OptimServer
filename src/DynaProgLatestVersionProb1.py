...
def calculateTardiness(S, J, j, res, data):
...
def F(S, J, res, data):
    ...
    if S == 1:
        res[tuple(J)] = [data[J[0]][0],
                         calculateTardiness(S, J, J[0], res, data), J, J[0]]
        return
